...
public class MainActivity extends AppCompatActivity {
    ...
    //@BindView declare sekaligus inisialisasi view dengan menggunakan library ButterKnife
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentStatePagerItemAdapter adapter = new FragmentStatePagerItemAdapter(
                ...
                .add(FragmentPagerItem.of("New", PhotoFragment.class, PhotoFragment.arguments("new")))
                .add(FragmentPagerItem.of("My Photo", PhotoFragment.class, PhotoFragment.arguments("myphoto")))
                .create());
    ...
    @OnClick(R.id.btnAdd)
    public void add() {
        startActivity(new Intent(MainActivity.this, MenambahGambarActivity.class)); // memanggil aktifitas menambah gambar
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.mnLogout:
                Constant.mAuth.signOut(); //logout
                Constant.currentUser = null;
                startActivity(new Intent(MainActivity.this, LoginActivity.class)); //memanggil login activity
                finish();
                break;
        }
