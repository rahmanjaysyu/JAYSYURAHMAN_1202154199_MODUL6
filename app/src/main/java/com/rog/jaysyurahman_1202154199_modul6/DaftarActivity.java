                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(DaftarActivity.this, "Proses Mendaftar Berhasil!", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(DaftarActivity.this, LoginActivity.class)); //panggil login activity
                            finish();
                            //updateUI(user);
                        } else {
                            ...
                            Toast.makeText(DaftarActivity.this, "Gagal otentikasi.",
